...
export default removeUndefinedLocaleResources({
  ...
  'form.input.assignee.no-user-assigned.tooltip': 'Définir le responsable',
  ...
  /** Text used in the assignee input tooltip when there is no user assigned */
  'form.input.assignee.user-assigned.tooltip': 'Changer le responsable',
  ...
  'list.feedback.text': 'Aidez-nous à améliorer, <Link>partagez vos retours sur les Tâches</Link> ',
