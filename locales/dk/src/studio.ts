...
export default removeUndefinedLocaleResources({
  ...
  'asset-source.delete-dialog.usage-list.warning-image-is-in-use_named':
    '{{filename}} kan ikke slettes, fordi det er i brug. For at slette dette billede skal du først fjerne alle dens anvendelser.',
  ...
  'calendar.error.must-be-in-format': 'Skal være i formatet <Emphasis>{{exampleDate}}</Emphasis>',
  ...
  'changes.action.revert-all-confirm': 'Gendan alle',
  /** Prompt for confirming revert change (singular) label for field change action */
  'changes.action.revert-changes-confirm-change_one': 'Gendan ændring',
  /** Revert for confirming revert (plural) label for field change action */
  'changes.action.revert-changes-confirm-change_other': 'Gendan ændringer',
  /** Prompt for reverting changes for a field change */
  'changes.action.revert-changes-description': 'Er du sikker på, at du vil gendanne ændringerne?',
  /** Prompt for reverting changes for a group change, eg multiple changes */
  'changes.action.revert-changes-description_one': 'Er du sikker på, at du vil gendanne ændringen?',
  ...
  'form.error.missing-keys-alert.details.description':
    'Dette sker normalt, når elementer oprettes ved hjælp af en API-klient, og <code>_key</code>-egenskaben ikke er inkluderet.',
  /** Developer info */
  ...
  'inputs.array.error.cannot-resolve-initial-value-title':
    'Kan ikke opløse startværdi for typen: {{schemaTypeTitle}}: {{errorMessage}}.',
  /** Error label for toast when trying to upload one array item of a type that cannot be converted to array */
  'inputs.array.error.cannot-upload-unable-to-convert_one':
    'Følgende element kan ikke uploades, fordi der ikke er nogen kendt konvertering fra indholdstype til arrayelement:',
  /** Error label for toast when trying to upload multiple array items of a type that cannot be converted to array */
  'inputs.array.error.cannot-upload-unable-to-convert_other':
    'Følgende elementer kan ikke uploades, fordi der ikke er nogen kendt konvertering fra indholdstyper til arrayelement:',
  /** Error description for the array item tooltip that explains that the current type item is not valid for the list  */
  'inputs.array.error.current-schema-not-declare-description':
    'Det nuværende skema erklærer ikke elementer af typen <code>{{typeName}}</code> som gyldige for denne liste. Dette kan betyde, at typen er fjernet som en gyldig elementtype, eller at nogen andre har tilføjet den til deres eget lokale skema, som endnu ikke er udrullet.',
  ...
  'inputs.array.resolving-initial-value': 'Opløser startværdi…',
  /** Placeholder value for datetime input */
  'inputs.datetime.placeholder': 'f.eks. {{example}}',
  /** Acessibility label for button to open file options menu */
  'inputs.file.actions-menu.file-options.aria-label': 'Åbn filindstillingsmenu',
  /** Browse */
  ...
  'inputs.files.common.placeholder.upload-not-supported': 'Kan ikke uploade filer her',
  /** Clear upload */
  'inputs.files.common.stale-upload-warning.clear': 'Ryd upload',
  /** An upload has made no progress for at least `{{staleThresholdMinutes}}` minutes and likely got interrupted. You can safely clear the incomplete upload and try uploading again. */
  'inputs.files.common.stale-upload-warning.description':
    'En upload har ikke gjort fremskridt i mindst {{staleThresholdMinutes}} minutter og er sandsynligvis blevet afbrudt. Du kan sikkert rydde den ufuldstændige upload og prøve at uploade igen.',
  /** Incomplete upload */
  ...
  'inputs.image.actions-menu.edit-details.aria-label': 'Åbn billedredigeringsdialog',
  /** Accessibility label for button to open image options menu */
  'inputs.image.actions-menu.options.aria-label': 'Åbn billedindstillingsmenu',
  /** Select */
  ...
  'inputs.imagetool.description':
    'Juster rektanglet for at beskære billedet. Juster cirklen for at angive det område, der altid skal være synligt.',
  /** Error: `{{errorMessage}}` */
  'inputs.imagetool.load-error': 'Fejl: {{errorMessage}}',
  /** Loading image… */
  'inputs.imagetool.loading': 'Indlæser billede…',
  /** Hotspot & Crop */
  'inputs.imagetool.title': 'Hotspot & Crop',
  /** Convert to <code>`{{targetType}}`</code> */
  'inputs.invalid-value.convert-button.text': 'Konverter til <code>{{targetType}}</code>',
  /** The current value (<code>`{{actualType}}`</code>) */
  'inputs.invalid-value.current-type': 'Den aktuelle værdi (<code>{{actualType}}</code>)',
  /** The property value is stored as a value type that does not match the expected type. */
  'inputs.invalid-value.description':
    'Ejendomsværdien er gemt som en værditype, der ikke matcher den forventede type.',
  /** The value of this property must be of type <code>`{{validType}}`</code> according to the schema. */
  'inputs.invalid-value.details.description':
    'Værdien af denne ejendom skal være af typen <code>{{validType}}</code> ifølge skemaet.',
  ...
  'inputs.invalid-value.title': 'Ugyldig ejendomsværdi',
  /** Field groups */
  ...
  'inputs.portable-text.action.collapse-editor': 'Kollaps redaktøren',
  /** Label for action to edit an existing annotation */
  'inputs.portable-text.action.edit-annotation': 'Rediger annotation',
  /** Expand the editor to give more editing space */
  'inputs.portable-text.action.expand-editor': 'Udvid redaktør',
  ...
  'inputs.portable-text.action.remove-annotation': 'Fjern annotation',
  ...
  'inputs.portable-text.decorator.strike-through': 'Gennemstregning',
  /** Title of the "strong" decorator */
  'inputs.portable-text.decorator.strong': 'Fed',
  /** Title of the "underline" decorator */
  'inputs.portable-text.decorator.underline': 'Understregning',
  ...
  'inputs.portable-text.invalid-value.action-disclaimer':
    'BEMÆRK: Det er generelt sikkert at udføre handlingen ovenfor, men hvis du er i tvivl, så tag kontakt til dem, der er ansvarlige for konfigurationen af dit studie.',
  ...
  'inputs.portable-text.invalid-value.non-object-child.description':
    'Barn ved indeks <code>{{index}}</code> af blok med nøgle <code>{{key}}</code> er ikke et objekt.',
  /** Action presented when the Portable Text field value is invalid, when the Portable Text field is not an array, or the array is empty */
  'inputs.portable-text.invalid-value.not-an-array.action': 'Fjern værdien',
  ...
  'inputs.portable-text.invalid-value.not-an-object.description':
    'Element ved <code>{{index}}</code> er ikke et objekt,.',
  ...
  'inputs.portable-text.list-type.bullet': 'Punktopstillet liste',
  ...
  'inputs.reference.action-create-new-document-select': 'Opret ny…',
  /** Label for action to clear the current value of the reference field */
  'inputs.reference.action.clear': 'Ryd',
  /** Label for action to create a new document from the reference input */
  'inputs.reference.action.create-new-document': 'Opret ny',
  ...
  'inputs.reference.cross-dataset.feature-disabled-description':
    'Denne funktion er deaktiveret. Læs hvordan du aktiverer den i <DocumentationLink>dokumentationen</DocumentationLink>.',
  /** Title for a warning telling the user that the current project does not have the "cross dataset references" feature */
  'inputs.reference.cross-dataset.feature-unavailable-title':
    'Ikke tilgængelig funktion: Cross dataset reference',
  /** The cross-dataset reference points to a document with an invalid type  */
  'inputs.reference.cross-dataset.invalid-type':
    'Det refererede dokument er af en ugyldig type ({{typeName}}) <JsonValue/>',
  ...
  'inputs.reference.error.invalid-type-description':
    'Refereret dokument (<code>{{documentId}}</code>) er af typen <code>{{actualType}}</code>. Ifølge skemaet kan refererede dokumenter kun være af typen <AllowedTypes />.',
  ...
  'inputs.reference.error.search-failed-title': 'Referencesøgning mislykkedes',
  /** Alternative text for the image shown in cross-dataset reference input */
  'inputs.reference.image-preview-alt-text': 'Billedforhåndsvisning af det refererede dokument',
  /** Description for alert shown when a reference in a live-edit document is marked as being weak, the referenced document exists, AND the reference is supposed to be have been strengthened on publish */
  'inputs.reference.incomplete-reference.finalize-action-description':
    '<strong>{{referencedDocument}}</strong> er offentliggjort, og denne reference bør nu afsluttes.',
  ...
  'inputs.reference.incomplete-reference.strengthen-action-description':
    '<strong>{{referencedDocument}}</strong> er offentliggjort, og denne reference bør nu konverteres til en stærk reference.',
  ...
  'inputs.reference.strength-mismatch.is-strong-description':
    'Denne reference er <em>stærk</em>, men ifølge det aktuelle skema burde den være <em>svag</em>.',
  /** Explanation of the consequences of leaving the reference as weak instead of strong */
  'inputs.reference.strength-mismatch.is-weak-consquences':
    'Dette gør det muligt at slette det refererede dokument uden først at slette denne reference, hvilket efterlader dette felt med henvisning til et ikke-eksisterende dokument.',
  /** Description for alert shown when a reference is supposed to be strong, but the actual value is weak */
  'inputs.reference.strength-mismatch.is-weak-description':
    'Denne reference er <em>svag</em>, men ifølge det aktuelle skema burde den være <em>stærk</em>.',
  ...
  'inputs.reference.strength-mismatch.title': 'Referencestyrke misforhold',
  ...
  'insufficient-permissions-message.not-authorized-explanation_discard-changes':
    'Du har ikke tilladelse til at kassere ændringer i dette dokument.',
  /** The explanation when unable to duplicate a particular document */
  'insufficient-permissions-message.not-authorized-explanation_duplicate-document':
    'Du har ikke tilladelse til at duplikere dette dokument.',
  /** The explanation when unable to publish a particular document */
  'insufficient-permissions-message.not-authorized-explanation_publish-document':
    'Du har ikke tilladelse til at udgive dette dokument.',
  ...
  'search.error.unspecified-error-help-description': 'Prøv igen eller kontroller din forbindelse',
  ...
  'search.operator.array-count-equal.description_one':
    '<Field/> <Operator>har</Operator> <Value>{{count}} emne</Value>',
  'search.operator.array-count-equal.description_other':
    '<Field/> <Operator>har</Operator> <Value>{{count}} emner</Value>',
  ...
  'search.operator.array-count-not-equal.description_one':
    '<Field/> <Operator>har ikke</Operator> <Value>{{count}} emne</Value>',
  'search.operator.array-count-not-equal.description_other':
    '<Field/> <Operator>har ikke</Operator> <Value>{{count}} emner</Value>',
  'search.operator.array-count-not-equal.name': 'mængde er ikke',
  /**
   * Array should have a count within the range of given filter values.
   * Gets passed `{{from}}` and `{{to}}` values.
   **/
  'search.operator.array-count-range.description':
    '<Field/> <Operator>har mellem</Operator> <Value>{{from}} → {{to}} emner</Value>',
  'search.operator.array-count-range.name': 'mængde er mellem',
  ...
  'search.operator.array-reference-includes.name': 'indeholder',
  /* Array should not include the given reference */
  'search.operator.array-reference-not-includes.description':
    '<Field/> <Operator>indeholder ikke</Operator> <Value>{{value}}</Value>',
  'search.operator.array-reference-not-includes.name': 'indeholder ikke',
  ...
  'timeline.error.load-document-changes-description':
    'Dokumentets historiktransaktioner er ikke blevet påvirket.',
  /** Title for error when the timeline for the given document can't be loaded */
  'timeline.error.load-document-changes-title':
    'Der opstod en fejl under hentning af dokumentændringer.',
  /** Error description for when the document doesn't have history */
  'timeline.error.no-document-history-description':
    'Når indholdet af dokumentet ændres, vil versionerne af dokumentet fremgå i denne menu.',
  ...
  'timeline.operation.draft-discarded_timestamp': 'Kladde kasseret: {{timestamp, datetime}}',
