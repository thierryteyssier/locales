...
export default removeUndefinedLocaleResources({
  ...
  'action.publish.waiting': 'Venter på opgaverne er færdige før publicering',
  /** Message prompting the user to confirm that they want to restore to an earlier version*/
  'action.restore.confirm-dialog.confirm-discard-changes':
    'Er du sikker på, at du vil gendanne dette dokument?',
  ...
  'buttons.split-pane-close-button.title': 'Luk opdelt rude',
  /** The title for the close group button on the split pane on the document panel header */
  'buttons.split-pane-close-group-button.title': 'Luk rudegruppe',
  ...
  /** The text that appears in the subtitle `<summary>` that lists the datasets below the title */
  'confirm-delete-dialog.cdr-summary.subtitle_unavailable_one': 'Utilgængeligt dataset',
  /** The text that appears in the subtitle `<summary>` that lists the datasets below the title */
  'confirm-delete-dialog.cdr-summary.subtitle_unavailable_other': 'Utilgængelige datasets',
  /** The text that appears in the title `<summary>` that includes the list of CDRs (singular) */
  'confirm-delete-dialog.cdr-summary.title_one': '{{documentCount}} i et andet dataset',
  ...
  'confirm-delete-dialog.loading.text': 'Leder efter refererende dokumenter…',
  ...
  'document-inspector.dialog.title': 'Inspektion af <DocumentTitle/>',
  /** The title shown in the dialog header, when the document being inspected is not created yet/has no value */
  'document-inspector.dialog.title-no-value': 'Ingen værdi',
  /** Title shown for menu item that opens the "Inspect" dialog */
  'document-inspector.menu-item.title': 'Inspektør',
  ...
  'document-view.form-view.sync-lock-toast.description':
    'Vent venligst mens dokumentet synkroniseres. Dette sker normalt lige efter dokumentet er blevet publiceret, og det bør ikke tage mere end et par sekunder',
  ...
  'panes.document-operation-results.operation-success':
    'Udførte succesfuldt {{context}} på dokumentet',
  ...
  'panes.document-operation-results.operation-success_discardChanges':
    'Alle ændringer siden sidste publicering er nu forkastet. Det forkastede udkast kan stadig gendannes fra historikken',
  /** The text when a publish operation succeeded  */
  'panes.document-operation-results.operation-success_publish': 'Dokumentet blev publiceret',
  /** The text when an unpublish operation succeeded  */
  'panes.document-operation-results.operation-success_unpublish':
    'Dokumentet blev afpubliceret. Et udkast er blevet oprettet fra den seneste publicerede version.',
  ...
  'structure-error.header.text': 'Stødte på en fejl under læsning af struktur',
